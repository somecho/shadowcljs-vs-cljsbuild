...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_6438 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_6438(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_6439 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_6439(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_6443 = (function (reader,ch){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_6443(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_6444 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_6444(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_6446 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_6446(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_6447 = (function (reader){
var x__5393__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_6447(reader);
}
});
...
var G__6467 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__6468 = s.append(c);
c = G__6467;
s = G__6468;
continue;
}
