...
var digit_6936 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_6937__$1 = (vlq >>> (5));
while(true){
if((vlq_6937__$1 > (0))){
var digit_6938__$1 = (digit_6936 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_6938__$1));

var G__6942 = (vlq_6937__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__6943 = (vlq_6937__$1 >>> (5));
digit_6936 = G__6942;
vlq_6937__$1 = G__6943;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_6936));
}
break;
}
...
var G__6949 = i__$1;
var G__6950 = result__$1;
var G__6951 = shift__$1;
i = G__6949;
result = G__6950;
shift = G__6951;
continue;
